...
export class PhotoService {
    ...
    like(photoId: number) {
        ...
        return this.http.post(API + '/photos/' + photoId + '/like', {}, { observe: 'response' })
            ...
            })); // devolve um observable no error
    }
}

//Através do operador catchError podemos tratar erros, 
//evitando assim que se propague para quem realizou a inscrição no Observable.